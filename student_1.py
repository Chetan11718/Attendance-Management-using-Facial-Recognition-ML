...
class Student:
    def __init__(self,root):
        ...
        #first image
        img=Image.open(r"D:\Face_recog\cyan.png")
        img=img.resize((500,90),Image.ANTIALIAS)
        self.photoimg=ImageTk.PhotoImage(img)
        f_lbl=Label(self.root,image=self.photoimg)
        f_lbl.place(x=0,y=0,width=500,height=90)
        #second image
        
        img1=Image.open(r"D:\Face_recog\cyan.png")
        ...
        #third image
        img2=Image.open(r"D:\Face_recog\cyan.png")
        ...
        #bg image
        img3=Image.open(r"D:\Face_recog\pink.png")
        ...
        title_lbl = Label(bg_img,text="Student Management",font=("times new roman",35,"bold"),bg="white",fg="red")
        ...
        save_btn=Button(btn_frame,text="Save",command=self.add_data,width=16,font=("times new roman",12,"bold"),bg="red",fg="white")
        save_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame,text="Update",command=self.update_data,width=16,font=("times new roman",12,"bold"),bg="red",fg="white")
        ...
        reset_btn=Button(btn_frame,text="Reset",command=self.reset_data,width=16,font=("times new roman",12,"bold"),bg="red",fg="white")
        reset_btn.grid(row=0,column=3)

        btn_frame1=Frame(class_frame,bd=2,relief=RIDGE,bg="white")
        btn_frame1.place(x=0,y=245,width=620,height=35)

        take_btn=Button(btn_frame1,text="Take Photo",width=16,font=("times new roman",12,"bold"),bg="red",fg="white")
        take_btn.grid(row=0,column=0)

        update_btn=Button(btn_frame1,text="Update Photo",command=self.update_data,width=16,font=("times new roman",12,"bold"),bg="red",fg="white")
        update_btn.grid(row=0,column=1)
        ...
        search_btn=Button(search_frame,text="Search",width=10,font=("times new roman",12,"bold"),bg="red",fg="white")
        search_btn.grid(row=0,column=3,padx=2)

        show_btn=Button(search_frame,text="Show All",width=10,font=("times new roman",12,"bold"),bg="red",fg="white")
    ...
    #=================fetch data==============
    def fetch_data(self):
        conn = mysql.connector.connect(host="localhost",username="root",password="tanya123",database="face_recognizer")
        my_cursor = conn.cursor()
